...
================================================================================
					 オブジェクト指向＆＆ゲームプログラミング
	     Copyright (c) 2021 Human Academy Sendai. All rights reserved.
================================================================================

 【対象ＯＳ】
	 Microsoft Windows 10(2004)以降
 ...
 【バージョン】
	 * Version    2021.03.06      2021/08/28  03:10:03
...
//	m_pD3D = ::Direct3DCreate9(D3D_SDK_VERSION);
	...
	m_pD3D = ::Direct3DCreate9On12(D3D_SDK_VERSION, &d3d9on12Args, 1);
	if(m_pD3D == NULL) {
										  ...
										  const bool inUseSysMem)
{
	...
	const auto max_length = ::_tfullpath(FullPath, inFileName, MAX_PATH + 1);
...
IDXGFont* CDXGraphics9::CreateSpriteFont(LPCTSTR inFontName, const int inSize)
{
	...
	const auto buffer = ::lstrcpyn(font_desc.FaceName, inFontName, LF_FACESIZE - 1);
...
IDXGFont* CDXGraphics9::CreateDefaultFont()
{
	...
	const auto buffer = ::lstrcpyn(font_desc.FaceName, lf.lfFaceName, LF_FACESIZE - 1);
